...
function drawMainMenu() {
    ...
    /*if (!mobile) {
        ...
        canvas.drawImage(img_mainMenu, os.x,  os.y + 60, cwh(MENU_IMG_WIDTH), cwh(MENU_IMG_HEIGHT/2.4));
   // }

	  /* if (onButton("mm_playGame"))
                canvas.fillStyle ="black";// BARS_BUTTON_HOVER_COLOR;
       else
            ...
            canvas.fillText("NEW GAME", MENU_IMG_WIDTH/2 -MENU_IMG_WIDTH/2 +282, CANVAS_HEIGHT/2-42);
	  ...
	  /* if (onButton("mm_levelSelect"))
		...
		*/	
			...
			canvas.font = "24px Arial";
            canvas.textAlign = "left";
            canvas.fillText("CONTINUE", MENU_IMG_WIDTH/2 -MENU_IMG_WIDTH/2 + 488 , CANVAS_HEIGHT/2 -42);
        ...
        if (onButton("mm_mute2"))
            ...
            if (muteSFX && muteMusic) {
                canvas.fillText("UNMUTE", MENU_IMG_WIDTH/2 -MENU_IMG_WIDTH/2 +380 , CANVAS_HEIGHT/2 + 276);
            } else {
                canvas.fillText("MUTE", MENU_IMG_WIDTH/2 -MENU_IMG_WIDTH/2 +400 , CANVAS_HEIGHT/2 + 276);
            }
            canvas.beginPath();
      ...
      /*   if (onButton("mm_continue"))
            ...
            canvas.fillText("CONTINUE", MENU_IMG_WIDTH/2 -MENU_IMG_WIDTH/2 +360 , CANVAS_HEIGHT/2 + 206);
