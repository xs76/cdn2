...
function Camera(scene, options){
	...
	self.reset = function(){
		...
		self.frozen = false;
		self.updatePosition();
		console.log("POKI CAMERA TEST 3");

		// PLAY GAME AFTER PHOTO TAKEN
	...
	console.log("POKI CAMERA TEST 4");
	...
	self.update();
	console.log("POKI CAMERA TEST 5");
	...
	self.isOverTV = function(smaller){
		...
		var t = cy - h/2;
		var b = cy + h/2;
		console.log("POKI CAMERA TEST HUH");
