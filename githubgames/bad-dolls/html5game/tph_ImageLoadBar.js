...
function ImageLoadBar_hook(ctx, width, height, total, current, image) {
	...
	var barBackgroundColor = getc("bar_background_color", "#242238");
	var barForegroundColor = getc("bar_foreground_color", "#3498DB");
	var barBorderColor = getc("bar_border_color", "#D68910");
